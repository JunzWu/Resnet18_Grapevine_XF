...
class ClassActivationMapping(Base):
    ...
    def __call__(self, inputs, layer, target_class=None, postprocessing=None, guide=False): #lambda x: x
        ...
        return cam.detach().cpu().numpy()# image_with_heatmap.unsqueeze(0), { 'prediction': target_class }