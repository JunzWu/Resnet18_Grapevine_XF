...
class SaliencyMap(Base):
    ...
    def store_first_layer_grad(self, layer):
    ...
    def __call__(self, input_image, layer, guide=False, target_class=None, regression=False):
        ...
        if layer is None:
            ...
            layer = modules[0]
        # print(layer)
        self.store_first_layer_grad(layer)
        ...
        image = image.view(image.shape[1], image.shape[2])
        self.clean()

        return image#, { 'prediction': target_class }
